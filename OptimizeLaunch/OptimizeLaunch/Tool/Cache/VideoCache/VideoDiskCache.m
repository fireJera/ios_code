...
- (instancetype)initWithPath:(NSString *)path {
    ...
    NSLog(@"VideoCache tempPath:%@", _tempPath);
    NSLog(@"VideoCache finalPath:%@", _finalPath);
    NSLog(@"VideoCache trashPath:%@",_trashPath);
    return self;
}
