...
//    
//    WALMEAlbumListViewController *toVC = (WALMEAlbumListViewController *)[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
//    
...
//    HXPhotoViewCell *toCell = [toVC currentPreviewCell:fromVC.currentModelIndex];
//    
...
//    
//    if (!fromVC.bottomView.userInteractionEnabled) {
//        WALMEAlbumListViewController *toVC = (WALMEAlbumListViewController *)[self.transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
