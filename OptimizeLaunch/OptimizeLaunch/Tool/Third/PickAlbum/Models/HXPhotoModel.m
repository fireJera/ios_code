...
- (NSURL *)fileURL {
//    if (self.type == WALMEPhotoModelMediaTypeCameraVideo) {
//        return self.videoURL;
//    }
//    if (self.type != WALMEPhotoModelMediaTypeCameraPhoto) {
...
- (NSDate *)creationDate {
//    if (self.type == WALMEPhotoModelMediaTypeCameraPhoto || self.type == WALMEPhotoModelMediaTypeCameraVideo) {
//        return [NSDate date];
//    }
...
- (instancetype)initWithPHAsset:(PHAsset *)asset{
    if (self = [super init]) {
        self.asset = asset;
        self.type = WALMEPhotoModelMediaTypePhoto;
        self.type = WALMEPhotoModelMediaSubTypePhoto;
    }
    return self;
}
...
- (instancetype)initWithVideoURL:(NSURL *)videoURL videoTime:(NSTimeInterval)videoTime {
    if (self = [super init]) {
        self.type = WALMEPhotoModelMediaTypeVideo;
        self.subType = WALMEPhotoModelMediaSubTypeVideo;
...
//        UIImage  *image = [player thumbnailImageAtTime:0.1 timeOption:MPMovieTimeOptionNearestKeyFrame];
        ...
        self.videoURL = videoURL;
        self.videoTime = time;
        self.thumbPhoto = [UIImage imageInVideoUrl:videoURL];
    }
    return self;
}
...
- (instancetype)initWithImage:(UIImage *)image {
    ...
    if (self) {
        self.type = WALMEPhotoModelMediaTypePhoto;
        self.subType = WALMEPhotoModelMediaSubTypePhoto;
...
- (CGSize)endImageSize
{
    if (_endImageSize.width == 0 || _endImageSize.height == 0) {
        ...
        CGFloat height = [UIScreen mainScreen].bounds.size.height - 0;
