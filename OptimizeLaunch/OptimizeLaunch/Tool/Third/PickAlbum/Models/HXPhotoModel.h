...
typedef NS_ENUM(NSUInteger, WALMEPhotoModelMediaType) {
    WALMEPhotoModelMediaTypePhoto = 0,          // 照片
    WALMEPhotoModelMediaTypeLive,               // LivePhoto
    WALMEPhotoModelMediaTypeGif,                // gif图
    WALMEPhotoModelMediaTypeVideo,              // 视频
    WALMEPhotoModelMediaTypeAudio,              // 预留
    //    WALMEPhotoModelMediaTypeCameraPhoto,   // 通过相机拍的照片
    //    WALMEPhotoModelMediaTypeCameraVideo,   // 通过相机录制的视频
    WALMEPhotoModelMediaTypeCamera              // 跳转相机
};

typedef NS_ENUM(NSUInteger, WALMEPhotoModelMediaSubType) {
    WALMEPhotoModelMediaSubTypePhoto = 0,       // 照片
    WALMEPhotoModelMediaSubTypeVideo            // 视频
};
...
/**
 照片类型
 */
@property (assign, nonatomic) WALMEPhotoModelMediaType type;
@property (assign, nonatomic) WALMEPhotoModelMediaSubType subType;
...
@property (assign, nonatomic) float videoSecond;
/**
 选择的下标
 */
...
//2018-01-29 by jeremy
//在选中数组中的下标
@property (nonatomic, assign) int selectedPhotosIndex;
