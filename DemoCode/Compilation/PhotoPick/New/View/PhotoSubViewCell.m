...
////
//
//#import "PhotoSubViewCell.h"
//#import "PhotoModel.h"
//#import "CircleProgressView.h"
//#import "AlbumTool.h"
//
//@interface PhotoSubViewCell ()
//
...
//@end
//
//@implementation PhotoSubViewCell
//
...
//        [_deleteBtn setImage:[AlbumTool hx_imageNamed:@"compose_delete@2x.png"] forState:UIControlStateNormal];
...
//    if (!_liveIcon) {
//        _liveIcon = [[UIImageView alloc] initWithImage:[AlbumTool hx_imageNamed:@"compose_live_photo_open_only_icon@2x.png"]];
...
//    if (!_videoIcon) {
//        _videoIcon = [[UIImageView alloc] initWithImage:[AlbumTool hx_imageNamed:@"VideoSendIcon@2x.png"]];
//    }
//    return _videoIcon;
//}
//
