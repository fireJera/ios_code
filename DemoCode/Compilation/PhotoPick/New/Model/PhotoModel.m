...
- (NSURL *)fileURL {
//    if (self.type == PhotoModelMediaTypeCameraVideo) {
//        return self.videoURL;
//    }
//    if (self.type != PhotoModelMediaTypeCameraPhoto) {
...
- (NSDate *)creationDate {
//    if (self.type == PhotoModelMediaTypeCameraPhoto ||
//        self.type == PhotoModelMediaTypeCameraVideo) {
//        return [NSDate date];
//    }
...
//    if (self = [super init]) {
//        self.asset = asset;
//        self.type = PhotoModelMediaTypePhoto;
//        self.type = PhotoModelMediaSubTypePhoto;
//    }
//    return self;
//}
...
//    self = [super init];
//    if (self) {
//        self.type = PhotoModelMediaTypeCameraPhoto;
//        self.subType = PhotoModelMediaSubTypePhoto;
...
- (NSString *)videoTime {
    if (!_videoTime) {
        ...
        _videoTime = [AlbumTool getNewTimeFromDurationSecond:timeLength.integerValue];
    }
    return _videoTime;
}
