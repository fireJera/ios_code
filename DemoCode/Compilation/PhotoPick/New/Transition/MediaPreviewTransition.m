...
//
//@interface MediaPreviewTransition ()
//@property (assign, nonatomic) MediaPreviewTransitionType type;
//@end
//
//@implementation MediaPreviewTransition
////
////
////+ (instancetype)transitionWithType:(MediaPreviewTransitionType)type {
////    return [[self alloc] initWithTransitionType:type];
////}
////
////- (instancetype)initWithTransitionType:(MediaPreviewTransitionType)type {
////    self = [super init];
////    if (self)  {
////        self.type = type;
////    }
...
////    switch (self.type) {
////        case MediaPreviewTransitionTypePush:
...
////    if (self.type == MediaPreviewTransitionTypePush) {
////        return 0.45f;
////    }else {
////        return 0.25f;
////    }
