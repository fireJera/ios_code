////
////  MediaPreviewInteractiveTransition.m
////  PhotoPick
////
...
//#import "PhotoModel.h"
//
//@interface MediaPreviewInteractiveTransition ()
//
...
//
//@property (weak, nonatomic) AlbumListCell *tempCell;
...
//
//
//@implementation MediaPreviewInteractiveTransition
//
...
////
////    AlbumListViewController *toVC = (AlbumListViewController *)[transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
////
...
//    MediaPreviewViewController *fromVC = (MediaPreviewViewController *)[self.transitionContext viewControllerForKey:UITransitionContextFromViewControllerKey];
//    fromVC.view.alpha = scale;
//    self.bgView.alpha = fromVC.view.alpha;
//
//    if (!fromVC.bottomView.userInteractionEnabled) {
//        AlbumListViewController *toVC = (AlbumListViewController *)[self.transitionContext viewControllerForKey:UITransitionContextToViewControllerKey];
