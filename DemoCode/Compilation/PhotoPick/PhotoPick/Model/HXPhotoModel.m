...
- (NSURL *)fileURL {
    if (self.type == HXPhotoModelMediaTypePhotoCameraVideo) {
        return self.videoURL;
    }
    if (self.type != HXPhotoModelMediaTypePhotoCameraPhoto) {
...
- (NSDate *)creationDate {
    if (self.type == HXPhotoModelMediaTypePhotoCameraPhoto || self.type == HXPhotoModelMediaTypePhotoCameraVideo) {
        return [NSDate date];
    }
...
- (instancetype)initWithVideoURL:(NSURL *)videoURL videoTime:(NSTimeInterval)videoTime {
    if (self = [super init]) {
        self.type = HXPhotoModelMediaTypePhotoCameraVideo;
...
- (instancetype)initWithImage:(UIImage *)image {
    self = [super init];
    if (self) {
        self.type = HXPhotoModelMediaTypePhotoCameraPhoto;
