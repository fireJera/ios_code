...
typedef NS_ENUM(NSUInteger, HXHXPhotoModelMediaTypePhoto) {
    HXPhotoModelMediaTypePhoto = 0, // 照片
    HXPhotoModelMediaTypePhotoLivePhoto, // LivePhoto
    HXPhotoModelMediaTypePhotoGif,  // gif图
    HXPhotoModelMediaTypePhotoVideo,     // 视频
    HXPhotoModelMediaTypePhotoAudio,     // 预留
    HXPhotoModelMediaTypePhotoCameraPhoto,   // 通过相机拍的照片
    HXPhotoModelMediaTypePhotoCameraVideo,   // 通过相机录制的视频
    HXPhotoModelMediaTypePhotoCamera         // 跳转相机
};

typedef enum : NSUInteger {
    HXPhotoModelMediaSubTypePhoto = 0, // 照片
    HXPhotoModelMediaSubTypeVideo // 视频
} HXHXPhotoModelMediaSubType;
...
/**
 照片类型
 */
@property (assign, nonatomic) HXHXPhotoModelMediaTypePhoto type;
@property (assign, nonatomic) HXHXPhotoModelMediaSubType subType;
