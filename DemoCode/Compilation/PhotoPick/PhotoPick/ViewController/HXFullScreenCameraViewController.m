...
//            [self showOnlySureAlert:@"无法使用麦克风" message:@"请在设置-隐私-相机中允许访问相机"];
...
- (void)didNextBtnClick {
    ...
    if (!self.videoURL) {
        ...
        UIImage  *image = [UIImage imageInVideoUrl:self.videoURL];//[player thumbnailImageAtTime:1.0 timeOption:MPMovieTimeOptionNearestKeyFrame];
