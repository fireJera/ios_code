...
//        [self showOnlySureAlert:@"无法使用相机" message:@"请在设置-隐私-相机中允许访问相机"];
        
        //        UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"无法使用相机" message:@"请在设置-隐私-相机中允许访问相机" delegate:self cancelButtonTitle:nil otherButtonTitles:@"确定", nil];
        //        [alert show];
        return;
    }
...
//            [self showOnlySureAlert:@"无法使用麦克风" message:@"请在设置-隐私-相机中允许访问麦克风"];
            //            UIAlertView *alert = [[UIAlertView alloc] initWithTitle:@"无法使用麦克风" message:@"请在设置-隐私-相机中允许访问麦克风" delegate:self cancelButtonTitle:nil otherButtonTitles:@"确定", nil];
            //            [alert show];
            return;
        }
...
- (void)nextClick
{
    ...
    if (self.changePhotoBtn.selected) {
        ...
        [self clipVideoCompleted:^{
            ...
            UIImage  *image = [UIImage imageInVideoUrl:weakSelf.videoURL];//[player thumbnailImageAtTime:1.0 timeOption:MPMovieTimeOptionNearestKeyFrame];
...
- (void)clipVideoCompleted:(void(^)(void))completed failed:(void(^)(void))failed
{
