...
@interface HXDatePhotoViewController ()<UICollectionViewDataSource,UICollectionViewDelegate,
UICollectionViewDelegateFlowLayout,
//UIViewControllerPreviewingDelegate,
HXDatePhotoViewCellDelegate,HXDatePhotoBottomViewDelegate,
...
- (NSInteger)dateItem:(HXPhotoModel *)model {
    ...
    if (self.manager.showDateHeaderSection && self.manager.reverseDate && model.dateSection != 0) {
        ...
        if (model.type == HXPhotoModelMediaTypePhotoCameraPhoto || model.type == HXPhotoModelMediaTypePhotoCameraVideo) {
...
- (void)datePhotoViewCell:(HXDatePhotoViewCell *)cell didSelectBtn:(UIButton *)selectBtn {
    if (selectBtn.selected) {
        if (cell.model.type != HXPhotoModelMediaTypePhotoCameraVideo && cell.model.type != HXPhotoModelMediaTypePhotoCameraPhoto) {
            cell.model.thumbPhoto = nil;
            cell.model.previewPhoto = nil;
        }
        if ((cell.model.type == HXPhotoModelMediaTypePhoto || cell.model.type == HXPhotoModelMediaTypePhotoGif) || (cell.model.type == HXPhotoModelMediaTypePhotoVideo || cell.model.type == HXPhotoModelMediaTypePhotoLivePhoto)) {
            if (cell.model.type == HXPhotoModelMediaTypePhoto || cell.model.type == HXPhotoModelMediaTypePhotoGif || cell.model.type == HXPhotoModelMediaTypePhotoLivePhoto) {
                [self.manager.selectedPhotos removeObject:cell.model];
            }else if (cell.model.type == HXPhotoModelMediaTypePhotoVideo) {
                [self.manager.selectedVideos removeObject:cell.model];
            }
        }else if (cell.model.type == HXPhotoModelMediaTypePhotoCameraPhoto || cell.model.type == HXPhotoModelMediaTypePhotoCameraVideo) {
            if (cell.model.type == HXPhotoModelMediaTypePhotoCameraPhoto) {
                [self.manager.selectedPhotos removeObject:cell.model];
                [self.manager.selectedCameraPhotos removeObject:cell.model];
            }else if (cell.model.type == HXPhotoModelMediaTypePhotoCameraVideo) {
                [self.manager.selectedVideos removeObject:cell.model];
        ...
        if (cell.model.type == HXPhotoModelMediaTypePhoto || (cell.model.type == HXPhotoModelMediaTypePhotoGif || cell.model.type == HXPhotoModelMediaTypePhotoLivePhoto)) { // 为图片时
            [self.manager.selectedPhotos addObject:cell.model];
        }else if (cell.model.type == HXPhotoModelMediaTypePhotoVideo) { // 为视频时
            [self.manager.selectedVideos addObject:cell.model];
        }else if (cell.model.type == HXPhotoModelMediaTypePhotoCameraPhoto) {
            // 为相机拍的照片时
            [self.manager.selectedPhotos addObject:cell.model];
...
- (UICollectionView *)collectionView {
    ...
    - (void)setModel:(HXPhotoModel *)model {
        ...
        if (model.type == HXPhotoModelMediaTypePhotoCamera || model.type == HXPhotoModelMediaTypePhotoCameraPhoto || model.type == HXPhotoModelMediaTypePhotoCameraVideo) {
        ...
        }else if (model.type == HXPhotoModelMediaTypePhotoLivePhoto) {
    ...
    - (void)didSelectClick:(UIButton *)button {
        ...
        //
        //    }];
        if (self.model.type == HXPhotoModelMediaTypePhotoCamera) {
            return;
        }
