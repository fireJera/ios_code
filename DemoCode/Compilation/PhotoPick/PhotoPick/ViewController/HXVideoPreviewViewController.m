...
//    [self.view addSubview:self.maskView];
    ...
    [[NSNotificationCenter defaultCenter] addObserver:self selector:@selector(p_letad_pausePlayerAndShowNaviBar) name:AVPlayerItemDidPlayToEndTimeNotification object:self.playVideo.currentItem];
...
- (void)didNextClick:(UIButton *)button {
    ...
    if (self.manager.type == HXPhotoManagerSelectedTypePhotoAndVideo) {
        if (self.model.type == HXPhotoModelMediaTypePhotoVideo || self.model.type == HXPhotoModelMediaTypePhotoCameraVideo) {
