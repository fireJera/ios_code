...
- (void)layoutSubviews {
    ...
    _bgBtn.frame = _contentView.bounds;
...
- (void)didClickCard:(UIButton *)sender {
...
- (void)p_commonInit {
    ...
    [_bgBtn addTarget:self action:@selector(didSelectCard:) forControlEvents:UIControlEventTouchUpInside];
    [_contentView addSubview:_bgBtn];
